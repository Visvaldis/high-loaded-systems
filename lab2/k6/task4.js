...
export const options = {
  ...
  export default function () {
    ...
    for(let i = 0; i<batchSize; i++){
      ...
      let randomOrFirsPage =   utils.probability(0.5);
      let shouldOpenPost =     utils.probability(0.8);
      let randomOrFirstPost =  utils.probability(0.65);
      let shouldLeaveComment = utils.probability(0.2);
